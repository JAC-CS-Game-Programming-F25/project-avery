import { input } from "../src/globals.js";
...
export default class Game {
  ...
  gameLoop(currentTime = 0) {
    ...
    // Cap dt to a maximum value to avoid large jumps when the tab is unfocused
    deltaTime = Math.min(deltaTime, 0.1); // This caps dt to 0.1 seconds or 100 ms
